...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['tenant', 'last_name_en', 'first_name_en'], name='patients_pa_tenant__a74c33_idx'), models.Index(fields=['tenant', 'national_id'], name='patients_pa_tenant__d2d66d_idx')],
                'constraints': [models.UniqueConstraint(fields=('tenant', 'mrn'), name='unique_mrn_per_tenant')],
            },
        ),
    ]
