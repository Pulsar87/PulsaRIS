...
class FeeSchedule(models.Model):
    ...
    modality = models.ForeignKey("core.Modality", on_delete=models.CASCADE, null=True, blank=True)
...
class FeeScheduleItem(models.Model):
    ...
    modality = models.ForeignKey("core.Modality", on_delete=models.SET_NULL, null=True, blank=True)
